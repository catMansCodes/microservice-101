...
0. [Prerequisites](00-prerequisites/prerequisites.md)  
1. [Microservices Fundamentals](01-microservices-fundamentals/microservices-fundamentals.md)  
2. [Building First Microservice](02-building-first-microservice/building-first-microservice.md)  
3. [Inter-Service Communication](03-inter-service-communication/inter-service-communication.md)  
4. [Service Discovery](04-service-discovery/service-discovery.md)  
5. [Centralized Configuration](05-centralized-configuration/centralized-configuration.md)  
6. [API Gateway](06-api-gateway/api-gateway.md)  
7. [Security in Microservices](07-security-in-microservices/security-in-microservices.md)  
8. [Logging, Monitoring & Observability](08-logging-monitoring-observability/logging-monitoring-observability.md)  
9. [Event-Driven Microservices](09-event-driven-microservices/event-driven-microservices.md)  
